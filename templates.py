import torch
from dataset import MINDRSDataset
...
def set_template(args):
    if args.template is None:
        ...
        args.bert_num_blocks = 2 if args.dataset_code != MINDRSDataset.code() else 4
        args.bert_num_heads = 4 if args.dataset_code != MINDRSDataset.code() else 8
